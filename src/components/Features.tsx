...
function FeatureCard({ title, desc, icon }: { title: string; desc: string; icon: ReactNode }) {
  ...
  return (
    <div
      ...
      data-feature-card
      data-cursor-hover
      className="rounded-2xl border border-white/6 bg-bg-raised/75 p-7 backdrop-blur-sm transition-colors hover:border-white/14"
    >
...
export function Features() {
  ...
  return (
    <section ref={sectionRef} id="features" className="relative px-5 py-24 sm:px-8 sm:py-32">
